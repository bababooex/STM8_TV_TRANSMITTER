  ...
  45                     ; 5 @far @interrupt void NonHandledInterrupt(void)
  45                     ; 6 {
  46                     .text:	section	.text,new
  47  0000               f_NonHandledInterrupt:
  51  0000               L12:
  52                     ; 7     while (1);   // Trap unexpected interrupts
  54  0000 20fe          	jra	L12
  56                     .const:	section	.text
  57  0000               __vectab:
  58  0000 82            	dc.b	130
  60  0001 00            	dc.b	page(f_reset_handler)
  61  0002 0000          	dc.w	f_reset_handler
  62  0004 82            	dc.b	130
 ...
 160  0065 00            	dc.b	page(f_timer4_isr)
 161  0066 0000          	dc.w	f_timer4_isr
 ...
 234                     	xdef	__vectab
 235                     	xref	f_reset_handler
 236                     	xref	f_timer4_isr
