...
#include "swi2c.h"
//code based off of https://github.com/tom2238/arduino-mc44bs374t1/tree/master
// default i2c address
#define MC44BS374T1_ADDR      (0x65<<1)
...
typedef enum {
  ...
  MC44BS374T1_WM2_SPC_US,     // Sound phase comparison 1 µA upper source on SPLLFIL
  MC44BS374T1_WM2_SPC_LS      // Sound phase comparison 1 µA lower source on SPLLFIL
} MC44BS374T1_WMODE_2;

typedef struct {
    uint8_t i2c_address;    // 0xCA - default (8-bit write address)
